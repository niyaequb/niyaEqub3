...
<head>
    ...
    <title>Noor Academy API Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-auth-login">Authenticate user and return JWT token.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-auth-link-student-to-parent">
                                <a href="#endpoints-POSTapi-auth-link-student-to-parent">POST api/auth/link-student-to-parent</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-auth-me">Get authenticated user information.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-auth-logout">
                                <a href="#endpoints-POSTapi-auth-logout">Logout user by invalidating JWT token.</a>
                            </li>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^+?[1-9]\d{1,14}$/. Example: <code>+6627</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be 4 digits. Must match the regex /^\d{4}$/. Example: <code>1562</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"password\": \"l4m{o,+]\\\"OP&gt;@;4[\",
    \"type\": \"student\",
    \"phone_verified_at\": \"2026-01-22T06:18:38\",
    \"is_active\": false,
    \"secondary_phone\": \"+6627\",
    \"address\": \"udtdsufvyvddqamniihfq\",
    \"parent_id\": 17,
    \"grade\": 6,
    \"gender\": \"female\",
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="tcollins@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>tcollins@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>l4m{o,+]"OP&gt;@;4[</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
Must be one of:
<ul style="list-style-type: square;"><li><code>student</code></li> <li><code>parent</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone_verified_at"                data-endpoint="POSTapi-auth-register"
               value="2026-01-22T06:18:38"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-01-22T06:18:38</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="secondary_phone"                data-endpoint="POSTapi-auth-register"
               value="+6627"
               data-component="body">
    <br>
<p>Must match the regex /^+?[1-9]\d{1,14}$/. Example: <code>+6627</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="udtdsufvyvddqamniihfq"
               data-component="body">
    <br>
<p>Must not be greater than 500 characters. Example: <code>udtdsufvyvddqamniihfq</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="parent_id"                data-endpoint="POSTapi-auth-register"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the parents table. Example: <code>17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="grade"                data-endpoint="POSTapi-auth-register"
               value="6"
               data-component="body">
    <br>
<p>Must be at least 5. Must not be greater than 12. Example: <code>6</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="gender"                data-endpoint="POSTapi-auth-register"
               value="female"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_of_birth"                data-endpoint="POSTapi-auth-register"
               value="2020-05-19"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date before <code>today</code>. Example: <code>2020-05-19</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>allow_cross_grade</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-auth-register" style="display: none">
            <input type="radio" name="allow_cross_grade"
                   value="true"
                   data-endpoint="POSTapi-auth-register"
                   data-component="body"             >
            <code>true</code>
...
<p>Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-auth-link-student-to-parent">POST api/auth/link-student-to-parent</h2>
...
<span id="example-requests-POSTapi-auth-link-student-to-parent">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/auth/link-student-to-parent" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"parent_id\": 17,
    \"students\": [
        {
            ...
            \"grade\": 5,
            \"gender\": \"male\",
            \"date_of_birth\": \"2026-01-22T06:18:38\",
...
<span id="example-responses-POSTapi-auth-link-student-to-parent">
</span>
<span id="execution-results-POSTapi-auth-link-student-to-parent" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-auth-link-student-to-parent"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-auth-link-student-to-parent"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-auth-link-student-to-parent" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-auth-link-student-to-parent">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-auth-link-student-to-parent" data-method="POST"
      data-path="api/auth/link-student-to-parent"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-auth-link-student-to-parent', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-auth-link-student-to-parent"
                    onclick="tryItOut('POSTapi-auth-link-student-to-parent');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-auth-link-student-to-parent"
                    onclick="cancelTryOut('POSTapi-auth-link-student-to-parent');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-auth-link-student-to-parent"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/auth/link-student-to-parent</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="parent_id"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the parents table. Example: <code>17</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="students.0.name"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="students.0.phone"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="+6627"
               data-component="body">
    <br>
<p>Must match the regex /^+?[1-9]\d{1,14}$/. Example: <code>+6627</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="students.0.email"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="tcollins@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>tcollins@example.com</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="students.0.password"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="l4m{o,+]"OP>@;4["
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>l4m{o,+]"OP&gt;@;4[</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="students.0.grade"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="5"
               data-component="body">
    <br>
<p>Must be between 5 and 12. Example: <code>5</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>gender</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="students.0.gender"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="male"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="students.0.date_of_birth"                data-endpoint="POSTapi-auth-link-student-to-parent"
               value="2026-01-22T06:18:38"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-01-22T06:18:38</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-auth-link-student-to-parent" style="display: none">
            <input type="radio" name="students.0.allow_cross_grade"
                   value="true"
                   data-endpoint="POSTapi-auth-link-student-to-parent"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-auth-link-student-to-parent" style="display: none">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>-e/dl4m{o,+]"OP&gt;@</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-auth-me">Get authenticated user information.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-auth-logout">Logout user by invalidating JWT token.</h2>
